...
echo "</div>";
    ...
    echo "<div class='text-danger'>" . "No se encontro ningun pokemon" . "</div>"; //Esto hay que cambiar
    mostrarTodosLosPokemon($conexion);
}

mysqli_close($conexion);


//Esta funcion es lo mismo que mostrarTodosLosPokemones.php
function mostrarTodosLosPokemon($conexion){
$sql = "SELECT 
    p.*,
    t1.descripcion AS tipo1_nombre,
    t1.imagen AS tipo1_imagen,
